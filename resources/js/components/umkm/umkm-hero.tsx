                ...
                <div className="container mx-auto px-4 py-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <a href="#hero" className="text-gray-700 hover:text-blue-600 transition-colors">Beranda</a>
                            ...
                            <a href="#gallery" className="text-gray-700 hover:text-blue-600 transition-colors">Galeri Aktivitas</a>
            ...
            <section id="hero" className="relative min-h-screen bg-white overflow-hidden pt-20 pb-4">
                ...
                <div className="relative m-4">
                    ...
                    >
                        ...
                        <div className="relative z-10 h-full flex items-center">
                            <div className="container mx-auto px-8 py-16">
                                <div className="grid lg:grid-cols-2 gap-12 items-center">
                                    ...
                                    {/* Right Content - UMKM Unggulan Card */}
                                    <div className="relative flex justify-center lg:justify-end">
                                        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden w-full max-w-sm border border-gray-100 mb-4 lg:mb-0">
                                            {/* Card Header */}
                                            <div className="p-4 sm:p-6 pb-3 sm:pb-4">
                                                <div className="flex items-center justify-between mb-3 sm:mb-4">
                                                    <h3 className="font-semibold text-gray-900 text-base sm:text-lg">UMKM Unggulan</h3>
                                                    <button className="text-gray-400 hover:text-gray-600">⋯</button>
                                                </div>
                                            </div>
                                            
                                            {/* UMKM Image with Border/Padding */}
                                            ...
                                            <div className="px-6 pb-6">
                                                <Link
                                                    ...
                                                    className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-2 px-4 rounded-lg text-sm font-medium hover:from-blue-700 hover:to-green-700 transition-all duration-300 block text-center"
                                                >
                                                    Lihat Detail
                                                </Link>
                                            </div>
                        ...
                        {/* Scroll Indicator - Inside rounded background */}
