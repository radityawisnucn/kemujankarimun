...
export default function UmkmEdit({ umkm, categories }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        is_verified: umkm.is_verified || false,
        is_active: umkm.is_active !== undefined ? umkm.is_active : true
    });
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <Head title={`Edit UMKM - ${umkm.name}`} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Edit data UMKM: {umkm.name}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow">
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg">
                        <div className="flex justify-end space-x-3">
                            ...
                            >
                                {processing ? 'Menyimpan...' : 'Update UMKM'}
                            </button>
                        </div>
                    </div>
                </form>
